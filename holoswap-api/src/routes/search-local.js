    ...
    const result = await pool.query(
      `SELECT DISTINCT set_id, set_name, set_logo, set_symbol, set_total,
              ...
              CASE
                ...
                WHEN set_id LIKE 'swsh%' THEN 'Sword & Shield'
                WHEN set_id LIKE 'sm%' THEN 'Sun & Moon'
                WHEN set_id LIKE 'xy%' THEN 'XY'
                WHEN set_id LIKE 'bw%' THEN 'Black & White'
                WHEN set_id LIKE 'hgss%' THEN 'HeartGold SoulSilver'
                WHEN set_id LIKE 'pl%' THEN 'Platinum'
                WHEN set_id LIKE 'dp%' THEN 'Diamond & Pearl'
                WHEN set_id LIKE 'ex%' THEN 'EX'
                ...
                WHEN set_id LIKE 'si%' THEN 'Southern Islands'
                WHEN set_id LIKE 'tk%' THEN 'Trainer Kit'
                WHEN set_id LIKE 'pop%' THEN 'POP Series'
                WHEN set_id LIKE 'mcd%' THEN 'McDonalds Promos'
                WHEN set_id LIKE 'cel%' THEN 'Celebrations'
                WHEN set_id LIKE 'det%' THEN 'Detective Pikachu'
                ELSE 'Other'
              END as series,
              CASE
                WHEN set_id LIKE 'sv%' THEN 1
                WHEN set_id LIKE 'swsh%' THEN 2
                WHEN set_id LIKE 'sm%' THEN 3
                WHEN set_id LIKE 'xy%' THEN 4
                WHEN set_id LIKE 'bw%' THEN 5
                WHEN set_id LIKE 'hgss%' THEN 6
